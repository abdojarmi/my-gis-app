...
const detailedStyles = {
    ...
    defaultPointStyle: {
        symbol: 'fuelPump', // أو 'pin' إذا لم يتوفر رمز fuelPump بعد
        color: '#D32F2F',   // نفس اللون الافتراضي للرمز. إذا استخدمت 'pin'، اختر لونًا مناسبًا.
        size: 22
    }
},
...
"المناطق الخضراء والزراعة": {
    ...
    function getLayerNameFromProperties(properties) {
        ...
        geomCheck: ["Polygon", "MultiPolygon"] // مهم جدًا للتأكد أنها مضلعات
            ...
            // 4. محطات الوقود
            { 
        name: "محطات_الوقود", // تأكد من تطابق هذا الاسم
        keys: directMatchPropKeys, // للاحتياط، إذا كان اسم الطبقة في حقل عام
        keywords: {
            // الأولوية لـ Path إذا كان موجودًا (تتم معالجته بواسطة checkLayer)

            // كلمات مفتاحية من الحقول المميزة في جدولك
            'اسم المحطة': [
                "بتروم", "أفريقيا", "طوطال", "انويف", "أولى إنيرجي", "شل", // أضف أي شركات أخرى
                "محطة وقود", "محطة بنزين", "محطة" // كلمات عامة
            ],
            'الشركة المالكة': [ // غالبًا نفس قيم اسم المحطة
                "بتروم", "أفريقيا", "طوطال", "انويف", "أولى إنيرجي", "شل"
            ],
            'نوع الوقود': [ // إذا كان هذا الحقل يُستخدم أحيانًا
                "بنزين", "غازوال", "ديزل", "وقود"
            ],
            'الخدمات الإضافية': [ // كلمات قد تظهر في هذا الحقل
                "غسل السيارات", "وقود", "محروقات"
            ],
            // كلمات مفتاحية عامة من وسوم OSM إذا كانت بياناتك قد تحتوي عليها
            'amenity': ["fuel", "filling_station", "charging_station"],
            'shop': ["fuel"],
            'building': ["fuel_station"] // إذا كانت بعض البيانات تصنفها كنوع مبنى
        },
        geomCheck: ["Point"] // بناءً على الجدول، هي نقاط
            }, // <--- فاصلة هنا
